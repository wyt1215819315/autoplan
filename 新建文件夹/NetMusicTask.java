...
import com.github.task.netmusic.dao.AutoNetmusicDao;
...
public class NetMusicTask {
    ...
    public void runTask(Integer autoId, Integer userid, AutoNetmusic autoNetmusic){
        ...
        //日志写入至数据库
        HistoryTaskLog netlog = new HistoryTaskLog(autoId, "netmusic", autoNetmusic1.getStatus(), userid, new Date(), msg.toString());
