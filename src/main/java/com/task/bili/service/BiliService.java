package com.task.bili.service;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.task.bili.dao.AutoBilibiliDao;
...
import com.task.bili.model.task.config.*;
...
import com.system.task.BiliTask;
...
public class BiliService {
    ...
    public PageDataVO<BiliPlan> queryPageList(Integer page, Integer limit) {
        ...
        for (BiliPlan biliPlan : biliPlans) {
            biliPlan.setBiliName(com.system.util.StringUtils.userNameEncode(biliPlan.getBiliName()));
        }
