package com.task.netmusic.service;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.task.netmusic.dao.AutoNetmusicDao;
import com.task.netmusic.model.AutoNetmusic;
import com.task.netmusic.util.NeteaseMusicUtil;
...
import com.system.task.NetMusicTask;
...
public class NetmusicService {
    ...
    public PageDataVO<AutoNetmusic> queryPageList(Integer page, Integer limit) {
        ...
        for (AutoNetmusic autoNetmusic : autoNetmusicList) {
            ...
            autoNetmusic.setNetmusicName(com.system.util.StringUtils.userNameEncode(autoNetmusic.getNetmusicName()));
        }
