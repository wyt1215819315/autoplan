...
CREATE TABLE `auto_bilibili`  (
  ...
  `taskIntervalTime` int(0) NOT NULL DEFAULT 10 COMMENT '任务之间的执行间隔',
  `numberOfCoins` int(0) NOT NULL DEFAULT 5 COMMENT '每日投币数量',
  `reserveCoins` int(0) NOT NULL DEFAULT 50 COMMENT '预留的硬币数',
  `selectLike` int(0) NOT NULL DEFAULT 0 COMMENT '投币时是否点赞，默认 0, 0：否 1：是',
  ...
  `coinAddPriority` int(0) NOT NULL DEFAULT 1 COMMENT '0：优先给热榜视频投币，1：优先给关注的 up 投币',
...
CREATE TABLE `auto_log`  (
  ...
  `bi_auto_id` int(0) NULL DEFAULT NULL,
  `net_auto_id` int(0) NULL DEFAULT NULL,
...
CREATE TABLE `bili_user`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `auto_id` int(0) NULL DEFAULT NULL,
  ...
  `bili_exp` bigint(0) NULL DEFAULT NULL,
  `bili_upexp` bigint(0) NULL DEFAULT NULL,
  `bili_level` int(0) NULL DEFAULT NULL,
